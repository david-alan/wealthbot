...
class RisksController extends AclController
{
    public function indexAction()
    {
        ...
        return $this->render('WealthbotAdminBundle:Risks:index.html.twig', array(
            'questions' => $questions
        ));
    }
    ...
    public function createQuestionAction(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($form->isValid()) {
                ...
                return $this->getJsonResponse(array(
                    'status' => 'success',
                    'new_row' => $this->renderView('WealthbotAdminBundle:Risks:_question_row.html.twig', array('question' => $question))
                ));
            } else {
                return $this->getJsonResponse(array(
                    'status' => 'error',
                    'form' => $this->renderView('WealthbotAdminBundle:Risks:_question_form.html.twig', array('form' => $form->createView()))
                ));
            }
        }
        ...
        return $this->getJsonResponse(array(
            'status' => 'success',
            'content' => $this->renderView('WealthbotAdminBundle:Risks:_question_form.html.twig', array(
    ...
    public function editQuestionAction(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($form->isValid()) {
                ...
                return $this->getJsonResponse(array(
                    'status' => 'success',
                    'content' => $this->renderView('WealthbotAdminBundle:Risks:_question_row.html.twig', array('question' => $question))
                ));
            } else {
                return $this->getJsonResponse(array(
                    'status' => 'error',
