...
use Wealthbot\SignatureBundle\Docusign\AbstractDocusign;
...
use Wealthbot\SignatureBundle\Model\AccountTabsConfigurationFactory;
...
{
    /** @var \Wealthbot\SignatureBundle\Docusign\AbstractDocusign */
    private $docusignApi;

    /** @var \Wealthbot\SignatureBundle\Manager\DocumentSignatureManager */
    private $signatureManager;

    /** @var \Wealthbot\SignatureBundle\Manager\AccountDocusignManager */
    ...
    private function getTemplateForSignableObject(SignableInterface $object)
    {
        ...
        switch ($type) {
            case DocumentSignature::TYPE_OPEN_OR_TRANSFER_ACCOUNT:
                if ($accountType === SystemAccount::TYPE_PERSONAL_INVESTMENT ||
                    $accountType === SystemAccount::TYPE_JOINT_INVESTMENT
                ) {
