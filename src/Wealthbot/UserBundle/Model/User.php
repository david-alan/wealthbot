...
class User extends BaseUser
{
    ...
    protected function addRiaDashboardBoxe(\Wealthbot\RiaBundle\Entity\RiaDashboardBox $riaDashboardBox)
    {
    ...
    protected function removeRiaDashboardBoxe(\Wealthbot\RiaBundle\Entity\RiaDashboardBox $riaDashboardBox)
    {
        $this->riaDashboardBoxes->removeElement($riaDashboardBox);
    }

    public function addRiaDashboardBox(\Wealthbot\RiaBundle\Entity\RiaDashboardBox $riaDashboardBox)
    {
        return $this->addRiaDashboardBoxe($riaDashboardBox);
    }

    public function removeRiaDashboardBox(\Wealthbot\RiaBundle\Entity\RiaDashboardBox $riaDashboardBox)
    {
    ...
    public function addClientActivitySummary(\Wealthbot\ClientBundle\Entity\ClientActivitySummary $clientActivitySummary)
    {
    ...
    public function removeClientActivitySummary(\Wealthbot\ClientBundle\Entity\ClientActivitySummary $clientActivitySummary)
    {
