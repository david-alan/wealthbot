...
class RiskQuestionRepository extends EntityRepository
{
     ...
     * @return \Wealthbot\RiaBundle\Entity\RiskQuestion $question | null
     */
    public function getOneQuestionOrderedBySequence($firstResult = null)
    {
        $query = $this->getEntityManager()->createQueryBuilder()
            ->select('rq')
            ->from('WealthbotRiaBundle:RiskQuestion', 'rq')
    ...
    public function getClonedAdminQuestions(\Wealthbot\UserBundle\Entity\User $owner, $order = 'asc')
    {
        $em = $this->_em;
