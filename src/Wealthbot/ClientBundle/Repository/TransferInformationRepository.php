...
/**
 * TransferInformationRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class TransferInformationRepository extends EntityRepository implements SignableObjectRepositoryInterface
{
    /**
    ...
    public function isApplicationSigned($applicationId)
    {
        $sql = 'SELECT count(ds.id) FROM document_signatures ds
                LEFT JOIN transfer_information ti ON (ds.source_id = ti.id AND ds.type = :type)
                LEFT JOIN client_accounts ca ON (ti.client_account_id = ca.id)
        ...
        $stmt->bindValue('type', DocumentSignature::TYPE_TRANSFER_INFORMATION);
