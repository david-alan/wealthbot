...
class SystemAccountManager implements SystemAccountManagerInterface
{
    ...
    /** @var \Wealthbot\ClientBundle\Manager\ClientAccountValuesManager */
    ...
    {
        if ($isClientView) {
            $accounts = $this->em->getRepository('WealthbotClientBundle:SystemAccount')->findByClientIdAndNotStatus(
                $client->getId(),
