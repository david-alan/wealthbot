...
use Wealthbot\ClientBundle\Model\ClientAdditionalContact as BaseClientAdditionalContact;
...
class ClientAdditionalContact extends BaseClientAdditionalContact implements AccountOwnerInterface
{
     ...
     *
     * @param integer $employmentStateId
     * @return ClientAdditionalContact
     */
     ...
     * Set employmentState
     *
     * @param \Wealthbot\AdminBundle\Entity\State $employmentState
     * @return ClientAdditionalContact
     */
    public function setEmploymentState(\Wealthbot\AdminBundle\Entity\State $employmentState = null)
    {
