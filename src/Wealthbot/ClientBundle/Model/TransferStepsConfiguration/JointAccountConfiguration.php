...
class JointAccountConfiguration implements TransferStepsConfigurationInterface
{
    /**
    ...
    public function getNextStep($currentStep)
    {
        switch ($currentStep) {
            ...
            case ClientAccount::STEP_ACTION_PERSONAL:
                $nextStep = ClientAccount::STEP_ACTION_ADDITIONAL_BASIC;
                break;

            case ClientAccount::STEP_ACTION_ADDITIONAL_BASIC:
                $nextStep = ClientAccount::STEP_ACTION_ADDITIONAL_PERSONAL;
                break;
    ...
    public function getPreviousStep($currentStep)
    {
        switch ($currentStep) {
            ...
            case ClientAccount::STEP_ACTION_ADDITIONAL_PERSONAL:
                $prevStep = ClientAccount::STEP_ACTION_ADDITIONAL_BASIC;
                break;
