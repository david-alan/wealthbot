...
class UserAccountOwnerAdapter implements AccountOwnerInterface
{
    ...
    public function __construct(User $user)
    {
        ...
        if (!$this->user->getClientPersonalInformation()) {
            $personalInformation = new \Wealthbot\ClientBundle\Entity\PersonalInformation();
    ...
    public function setState(\Wealthbot\AdminBundle\Entity\State $state)
    {
    ...
    public function setEmploymentState(\Wealthbot\AdminBundle\Entity\State $state = null)
    {
