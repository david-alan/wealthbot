...
class ProfileController extends AclController
{
    ...
    {
        return $this->render('WealthbotClientBundle:Default:index.html.twig', array('name' => $name));
    }
    ...
    public function stepOneAction(Request $request)
    {
        ...
        return $this->render('WealthbotClientBundle:Profile:step_one.html.twig', array(
    ...
    public function stepTwoAction(Request $request)
    {
        ...
        if($request->isMethod('post')){
            $formHandler = new ClientQuestionsFormHandler($form, $request, $em, array(
        ...
        return $this->render('WealthbotClientBundle:Profile:step_two.html.twig', array(
    ...
    public function stepThreeAction(Request $request)
    {
        ...
        return $this->render('WealthbotClientBundle:Profile:step_three.html.twig', array(
            'form' => $form->createView(),
            'client' => $user,
            'ria_company_information' => $user->getProfile()->getRia()->getRiaCompanyInformation()
    ...
    public function showAccountOwnerFormAction(Request $request)
    {
        ...
        if (!$client->isMarried() && $this->getAccountType() !== 'joint account') {
            return $this->getJsonResponse(array('status' => 'error', 'message' => 'Client does not married.'));
        }

        if (null === $group) {
            return $this->getJsonResponse(array('status' => 'error', 'message' => 'Select type of account.'));
        }
        ...
        if (empty($owners)) {
            return $this->getJsonResponse(array(
                'status' => 'error',
                'form' => $this->renderView('WealthbotClientBundle:Profile:_account_owner_form.html.twig', array(
                    'form' => $form->createView(),
                    'client' => $client
                ))
            ));
    ...
    public function updateAccountOwnerFormAction(Request $request)
    {
        ...
        return $this->getJsonResponse(array(
            'status' => 'success',
            'content' => $this->renderView('WealthbotClientBundle:Profile:_other_account_owner_form.html.twig', array(
                'form' => $form->createView(),
                'client' => $client
            ))
        ));
    ...
    public function showDepositAccountFormAction(Request $request)
    {
        ...
        $depositAccountGroupForm->bind($request);
    ...
    public function showAccountFormAction(Request $request)
    {
        ...
        if ($accountGroupForm->isValid()) {
            ...
            if ($group == AccountGroup::GROUP_DEPOSIT_MONEY) {
                ...
                return $this->getJsonResponse(array(
                    'status' => 'success',
                    'form' => $this->renderView('WealthbotClientBundle:Profile:_select_account_type_form.html.twig', array(
                        'form' => $form->createView(),
                        'group' => $group
                    ))
                ));
    ...
    public function updateAccountFormAction(Request $request)
    {
        ...
        return $this->getJsonResponse(array(
            'status' => 'success',
            'content' => $this->renderView('WealthbotClientBundle:Profile:_client_accounts_form_fields.html.twig', array(
                'form' => $form->createView()
            ))
        ));
    }
    ...
    public function accountsAction(Request $request)
    {
        ...
        if (!in_array($group, $groups)) {
            return $this->redirect($this->generateUrl('rx_client_profile_step_three_accounts', array(
                'group' => $groups[0]
            )));
        }
        ...
        $accounts = $clientAccountRepo->findBy(array('client_id' => $client->getId()));
        ...
        if ($request->isMethod('post')) {
            ...
            if (array_key_exists($groupIndex+1, $groups)) {
                $url = $this->generateUrl('rx_client_profile_step_three_accounts', array('group' => $groups[$groupIndex+1]));
            } else {
        ...
        return $this->render('WealthbotClientBundle:Profile:step_three_accounts.html.twig', array(
            'form' => $form->createView(),
            'client' => $client,
            'accounts' => $accounts,
            'group' => $group,
    ...
    public function accountsFundsAction(Request $request)
    {
        ...
        $accounts = $repo->findBy(array('client_id' => $client->getId()));
        ...
        return $this->render('WealthbotClientBundle:Profile:step_three_accounts_funds.html.twig', array(
            'client' => $client,
            'accounts' => $accounts,
    ...
    public function createAccountAction(Request $request)
    {
        ...
        if ($process) {
            ...
            if ($group == 'employer_retirement'){
                ...
                $responseData['transfer_url'] = $this->generateUrl(
                    ...
                    array('account_id' => $clientAccount->getId())
                );
            }
        ...
        return $this->getJsonResponse(array(
            'status' => 'error',
            'form' => $this->renderView('WealthbotClientBundle:Profile:_client_accounts_form.html.twig', array(
                'form' => $form->createView(),
                'group' => $group,
    ...
    public function processEmployerRetirementAccountForm(ClientAccount $account)
    {
        ...
        return array(
            'status' => 'success',
            'content' => $this->renderView('WealthbotClientBundle:Profile:_retirement_account_funds.html.twig', array(
                'account' => $account,
                'form' => $form->createView(),
    ...
    public function showAccountsTableAction()
    {
        ...
        return $this->render('WealthbotClientBundle:Profile:_accounts_list.html.twig', array(
            'client' => $client,
            'total' => $total,
    ...
    public function editAccountAction(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($process) {
                ...
                return $this->getJsonResponse(array(
                        'status' => 'success',
                        'accounts' => $this->renderView('WealthbotClientBundle:Profile:_accounts_list.html.twig', array(
                            'client' => $client,
                            'total' => $total,
                            'show_action_btn' => true
                        )),
                        'retirement_accounts' => $this->renderView('WealthbotClientBundle:Profile:_retirement_accounts_list.html.twig', array(
                            'retirement_accounts' => $retirementAccounts
                        ))
                    ));
            } else {
        ...
        return $this->getJsonResponse(array(
                'status' => $status,
                'form' => $this->renderView('WealthbotClientBundle:Profile:_edit_client_account_form.html.twig', array(
                    'form' => $form->createView(),
                    'account' => $account
                ))
            ));
    ...
    public function deleteAccountAction(Request $request)
    {
        ...
        if ($account) {
            ...
            if ($request->isXmlHttpRequest()) {
                return $this->getJsonResponse(array('status' => 'error', 'message' => $message));
            }
    ...
    public function outsideFundAction(Request $request)
    {
        ...
        $account = $em->getRepository('WealthbotClientBundle:ClientAccount')->findOneBy(array(
    ...
    public function createOutsideFundAction(Request $request)
    {
        ...
        if (!$accountId) {
            return $this->getJsonResponse(array('status' => 'error', 'message' => 'Not defined parameter account_id.'));
        }
        ...
        if (!$account) {
            return $this->getJsonResponse(array('status' => 'error', 'message' => 'Retirement Account with id: '.$accountId.' does not exist.'));
        }
        ...
        try {
            ...
            if ($process) {
                return $this->getJsonResponse(array(
                    'status' => 'success',
                    'content' => $this->renderView('WealthbotClientBundle:Profile:retirement_funds_list.html.twig', array('account' => $account))
                ));
                ...
                return $this->getJsonResponse(array(
                    'status' => 'error',
                    'message' => 'Not valid.',
                    'content' => $this->renderView('WealthbotClientBundle:Profile:retirement_account_fund_form.html.twig', array('form' => $form->createView()))
                ));
            }
    ...
    public function deleteOutsideAccountFundAction(Request $request)
    {
        ...
        if (!$account) {
            return $this->getJsonResponse(
                array('status' => 'error', 'message' => sprintf('You have not account with id: %s.', $accountId))
            );
        }
    ...
    public function updateTransferInformationFormAction(Request $request)
    {
        ...
        return $this->getJsonResponse(array(
            ...
            'content' => $this->renderView(
                ...
                array('form' => $form->createView(), 'hide_errors' => true)
            )
        ));
    }
    ...
    private function getAccountFormByGroup($group) {
        ...
        if ($group === AccountGroup::GROUP_FINANCIAL_INSTITUTION || $group === AccountGroup::GROUP_DEPOSIT_MONEY) {
            $content =  $this->renderView('WealthbotClientBundle:Profile:_select_account_type_form.html.twig', array(
                'form' => $this->createForm(new AccountTypesFormType($user, $group), array('groups' => $group))->createView(),
                'group' => $group
            ));
    ...
    private function getAccountFormByGroupAndGroupType($group, $groupType)
    {
        ...
        if (!$user->isMarried() && $this->getAccountType() !== 'joint account') {
            ...
            $content = $this->renderView('WealthbotClientBundle:Profile:_client_accounts_form.html.twig', array(
                'form' => $form->createView(),
                'group' => $group,
                'hide_submit_button' => true,
                'title_message' => $message
    ...
    private function getAccountOwnerFormView(User $client, EntityManager $em, $isJoint = false)
    {
        ...
        return $this->renderView('WealthbotClientBundle:Profile:_account_owner_form.html.twig', array(
            'form' => $form->createView(),
            'client' => $client
        ));
    }
    ...
    private function getAccountFormView(User $client, $group)
    {
        ...
        return $this->renderView('WealthbotClientBundle:Profile:_client_accounts_form.html.twig', array(
            'form' => $form->createView(),
            'group' => $group,
            'hide_submit_button' => true,
            'title_message' => $message
    ...
    {
        return $this->get('session')->get('client.accounts.account_owners', array());
    }
