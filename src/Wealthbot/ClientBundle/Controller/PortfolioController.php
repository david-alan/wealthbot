...
class PortfolioController extends AclController
{
    ...
    public function outsideFundsAction(Request $request)
    {
        ...
        return $this->getJsonResponse(array(
            'status' => 'success',
            'content' => $this->renderView('WealthbotClientBundle:Portfolio:_outside_funds_list.html.twig', array(
                'account' => $account
            ))
        ));
    }
    ...
    public function consolidatedAccountsAction(Request $request)
    {
        ...
        return $this->getJsonResponse(array(
            'status' => 'success',
            'content' => $this->renderView('WealthbotClientBundle:Portfolio:_consolidated_accounts_list.html.twig', array(
                'client' => $client,
     ...
     * @return bool
     */
    private function containsSasCash(array $accounts = array())
    {
